...
namespace Assignment2.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Category> Categories { get; set; }//Properties- it is a table for categories

        public DbSet<Pie> Pies { get; set; }//Properties- it is a table for pies

        //seeding data
        //this method is used to seed data.. appdb can work without this method
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 2, CategoryName = "Cheese cakes", Description = "Cheese cake" });
